...
function doFormatJson(scenario, tranMap, prizeMap) {
	...
	r.push('<tr>');
	r.push('<td style="padding-right:10px" class="tablehead" colspan="8">');
	...
	r.push('<tr>');
	r.push('<td style="padding-right:10px" class="tablebody" colspan="2">');
	r.push(tranMap.symbol);
	r.push('</td>');
	for(var i=0;i<6;i++){
		r.push('<td style="padding-right:10px" class="tablebody" >');
	...
	r.push('<tr>');
	str = '<td style="padding-right:10px" class="tablehead" colspan='+ standardBonusLength +'>';
	r.push(str);
	r.push(tranMap.warpBonusTitle);
	r.push('</td>');
	r.push('</tr>');
	
	str = '<td style="padding-right:10px" class="tablebody" colspan='+ standardBonusLength +'>';
	...
	if(result.actionsBonus.length){
		...
		r.push('<table border="0" cellpadding="2" cellspacing="1" class="gameDetailsTable" >');
		r.push('<tr>');
		r.push('<td style="padding-right:10px" class="tablehead" >');
		r.push(tranMap.whirlBonusTitle);
		r.push('</td>');
		r.push('</tr>');
