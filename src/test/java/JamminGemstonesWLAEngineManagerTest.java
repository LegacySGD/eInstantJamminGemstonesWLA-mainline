...
public class JamminGemstonesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JamminGemstonesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JamminGemstonesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JamminGemstonesWLAIW/InitOutcome.xml").getDocumentElement();
